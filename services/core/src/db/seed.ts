...
console.log("seeded: city=1 Bengaluru, 6 fare cards, rider", rider.id, "+ 3 approved drivers");
console.log("login phones — rider:", riderPhone, "| drivers:", drivers.map((d) => d[0]).join(", "));
